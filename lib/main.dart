  ...
  try {
    ...
    try {
      ...
      if (exercises.isEmpty) {
        ...
        // If exercises exist but no current exercise is set, select the most appropriate one
        final sessionService = SessionService();
        if (sessionService.currentExercise == null && exercises.isNotEmpty) {
          final defaultExercise = await sessionService.selectDefaultExercise();
          sessionService.setExercise(defaultExercise);
          debugPrint('Set default exercise as current: ${defaultExercise.name}');
        }
      }
    } catch (readError) {
