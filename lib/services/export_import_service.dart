...
class ExportImportService {
  ...
  Future<Map<String, dynamic>> exportAllData() async {
    final exercises = await _storage.loadAllExercises(); // Include deleted exercises
    final results = await _storage.getAllResultsIncludingDeleted(); // Include deleted results
  ...
  /// Apply imported data to storage (merges with existing data)
