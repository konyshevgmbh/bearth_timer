...
class _DeleteAccountPageState extends State<DeleteAccountPage> {
  ...
  Future<void> _sendDeleteOTP() async {
    if (_userEmail == null) {
      setState(() {
        _errorMessage = t.noUserEmailFound;
      });
      return;
    }
    ...
    try {
      ...
      if (success && mounted) {
        setState(() {
          _isOTPSent = true;
          _successMessage = t.verificationCodeSentTo(email: _userEmail!);
        });
  ...
  Future<void> _verifyOTPAndDelete() async {
    if (_otpController.text.isEmpty) {
      setState(() {
        _errorMessage = t.enterVerificationCode;
      });
      return;
    }
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(t.accountDataCleared),
      ...
      if (mounted) {
        setState(() {
          _errorMessage = t.failedToDeleteAccount;
        });
      }
    }
  }
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        _isOTPSent ? t.verifyDeletion : t.deleteAccountTitle,
                        style: TextStyle(
                      ...
                      if (!_isOTPSent) ...[
                        ...
                        if (!_showConfirmation) ...[
                          ...
                          // Confirmation screen
                          Text(
                            t.accountEmail(email: _userEmail ?? ''),
                            style: TextStyle(
                              fontSize: AppLayout.fontSizeSmall,
                              color: Theme.of(context).colorScheme.onSurfaceVariant,
                            ),
                          ...
                          Text(
                            t.sendVerificationCodeDescription,
                            style: TextStyle(
                              fontSize: AppLayout.fontSizeSmall,
                              color: Theme.of(context).colorScheme.onSurfaceVariant,
                            ),
