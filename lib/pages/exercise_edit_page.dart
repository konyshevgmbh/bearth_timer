...
class _ExerciseEditPageState extends State<ExerciseEditPage> {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
          appBar: AppBar(
            title: Text(widget.title.isEmpty ? t.edit : widget.title),
        ...
        Padding(
          ...
          child: Column(
            ...
            if (_exerciseService.canEditCycleDuration()) ...[
              ...
              SizedBox(height: AppLayout.sectionSpacingSmall),
              Text(
                '${t.step}: ${t.secondsUnit(value: cycleDurationStep)} (${t.secondsUnit(value: minCycleDuration)}-${t.secondsUnit(value: maxCycleDuration)})',
                style: TextStyle(
                  color: Theme.of(context).colorScheme.onSurfaceVariant,
                  fontSize: AppLayout.fontSizeSmall,
                ),
        ...
        return PopupMenuItem<int>(
          ...
          child: Row(
            ...
            children: [
              ...
              SizedBox(width: 8),
              Text(
                claps == 1 ? t.oneClap : t.clapsCount(count: claps),
                style: TextStyle(color: Theme.of(context).colorScheme.onSurface),
              ),
        ...
        Padding(
          ...
          child: _exerciseService.canEditCycleDuration()
              ? Row(
                  ...
                  children: [
                    _buildDurationInfo(t.minimum, minTotal, Theme.of(context).colorScheme.onSurfaceVariant),
                    _buildDurationInfo(t.current, currentTotal, Theme.of(context).colorScheme.primary),
                    _buildDurationInfo(t.maximum, maxTotal, Theme.of(context).colorScheme.onSurfaceVariant),
                  ],
                )
              : Center(
                  child: _buildDurationInfo(t.total, currentTotal, Theme.of(context).colorScheme.primary),
                ),
        ),
      ],
    );
